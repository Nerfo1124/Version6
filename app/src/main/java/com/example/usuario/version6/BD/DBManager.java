...
public class DBManager {
    ...
    public  int  insertar(String nombreU,String nombre, String apellido, String fecha, String sexo,String pregunta,
                          String respuesta ,String contraseña, String formula,String tamaño, String der, String izq, String fre){
        try {
            ...
            long i = db.insert(TABLE_NAME, null, generarContentValues(nombreU, nombre, apellido, fecha, sexo, pregunta,
                    respuesta, contraseña, formula));
            Toast.makeText(contexto,"Resultado DATO: "+objD.insertar(nombreU, tamaño, der, izq, fre), Toast.LENGTH_SHORT).show();
    ...
    public ContentValues generarContentValues(String nombreU,String nombre, String apellido, String fecha, String sexo,
                                              String pregunta, String respuesta, String contraseña, String  formula){
    ...
    public String consultacontrasenia( String nombreu) {
        try {
            String  r="";
            Cursor fila = db.rawQuery("select "+usu_contraseña+" from " + TABLE_NAME + " where " + usu_nombreusuario + "='" + nombreu + "'", null);
            fila.moveToFirst();
            r=fila.getString(0);
            return r;
        }catch (Exception e){
