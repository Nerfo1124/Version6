package com.example.usuario.version6.BD;
...
public class DBManager2 {
    ...
    public static final String dat_tamaño="dat_tamaño";
    ...
    public  int  insertar(String nombreu, String tamaño, String ojoder, String ojoizq,String frecuencia){
        try {
            long i = db.insert(TABLE_NAME, null, generarContentValuesString(nombreu, tamaño, ojoder, ojoizq, frecuencia));
    ...
    public ContentValues generarContentValuesString (String nombreU, String tamaño, String ojoder, String ojoizq,String frecuencia){
        ContentValues valores = new ContentValues();
        valores.put(dat_nombreusuario,nombreU);
        valores.put(dat_tamaño, tamaño);
